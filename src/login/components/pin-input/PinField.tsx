    ...
    (
        ...
        useEffect(() => {
            ...
            for (let index = 0; index < state.length; index++) {
                ...
                completed =
                    completed &&
                    index in state.values &&
                    refs.current[index].checkValidity();
                value += char;
            }
        ...
        return (
            <div
                className={clsx(
                    "pf-c-pin-field pf-l-flex pf-m-space-items-sm",
                    containerClassName
                )}
            >
                {inputs}
...
PinField.displayName = "Pin Field";
