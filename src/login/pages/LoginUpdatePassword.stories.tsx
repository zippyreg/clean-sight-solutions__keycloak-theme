...
/**
 * WithMessageDisplayed:
 * - Purpose: Tests when there is a warning message displayed.
 * - Scenario: Simulates the case where the user enters a temporary password, and a warning message is displayed to notify user of the requirement to update their password.
 * - Key Aspect: Ensures the password alert message is displayed correctly.
 */
export const WithMessageDisplayed: Story = {
    render: () => (
        <KcPageStory
            kcContext={{
                message: {
                    type: "warning",
                    summary: "Before you can continue you must update your password."
                }
            }}
        />
    )
