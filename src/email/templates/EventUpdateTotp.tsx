...
export const templateName = "Event: MFA Updated";

const { exp, v } = createVariablesHelper("event-update_totp.ftl");

export const Template = ({ locale }: TemplateProps) => (
    <EmailLayout
        preview={`Updates made to multifactor authentication for your ${exp("realmName")} account.`}
        locale={locale}
    >
        <Container>
            <HeroText>MFA updated.</HeroText>
            ...
            <Content>
                Multifactor authentication for your {exp("realmName")} account was updated
...
export const getSubject: GetSubject = async _props => {
    return labeledSubject("MFA updated");
};
